		...
		return (
			<div>
				<div style={{ display: "inline-block" }}>
					...
					<h4>Results for flights from airport {this.state.airportCode} between {this.state.hour} and {parseInt(this.state.hour, 10) + 1} hours on {this.state.day}/{this.state.month}/{this.state.year} ({this.state.flights.length} results sorted by destination)</h4>
